...
公开 [Roadmap](ROADMAP.md) 将下一阶段聚焦于可复现 endpoint 检查、报告复用与
经过验证的真实 client 案例。Registry、公共 matrix 与 hosted-service 候选不在
v0.1 的受支持范围内。
...
除非文件另有说明，源码和文档采用 [Apache License 2.0](LICENSE)。Vendored
依赖声明见 [THIRD_PARTY_LICENSES.txt](THIRD_PARTY_LICENSES.txt)。
