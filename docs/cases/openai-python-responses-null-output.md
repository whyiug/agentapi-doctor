...
Install the `v0.1.0-rc.3` Linux amd64 binary using the main README, and provide
...
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/whyiug/agentapi-doctor/v0.1.0-rc.3/runners/python/openai-responses/requirements-linux-x86_64-py312.lock \
  -o "$LOCK"
